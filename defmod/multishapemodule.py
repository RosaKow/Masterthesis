...
class MultiShapeModule_landmarks(torch.nn.Module):

    """ Input: List of modules (length n), the nth module is the background module; 
               List of boundary constraints ('identity' or 'sliding') (length n-1) """
    def __init__(self, module_list, constraints_list):
        super().__init__()
