...
class Compound(DeformationModule):
    ...
    def __call__(self, gd, controls, points) :
        ...
        print([gd[self.__indice_gd[0]:self.__indice_gd[1]], gd[self.__indice_gd[1]:self.__indice_gd[2]], gd[self.__indice_gd[2]:self.__indice_gd[3]]])
        return torch.sum(torch.cat(app_list), 0), app_list
    ...
    def action(self, gd, module, gd_module, controls_module) :
        ...
        return torch.cat(app_list), app_list
