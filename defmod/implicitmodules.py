...
from .kernels import K_xx, K_xy, compute_sks, eta, gauss_kernel, rel_differences
...
class ImplicitModule0(DeformationModule):
    ...
    def compute_geodesic_control(self, man):
        ...
        self.controls = controls.contiguous().view(-1) / self.__coeff
...
class ImplicitModule1(DeformationModule):
    ...
    def fill_controls_zero(self):
        self.fill_controls(torch.zeros(self.__dim_controls, requires_grad=True))
